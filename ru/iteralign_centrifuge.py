...
base_args=(
    ...
    #         required=True,
    #         action="store",
    #         help="The file path and name for the centrifuge report file that will contain all reference genome data from all iterations",
    #     ),
    # ),
    (
        "--reject",
    ...
    with open(os.devnull, 'w') as devnull:
        ...
        if taxid_result_set:
            ...
            if difference_set:
                ...
                url_set = set(summary_centrifuge[summary_centrifuge["taxid"].isin(difference_set)]["fasta_path"])
        ...
        """
        The rest of this function appears to not run. This code is nearly identical to the master branches iteralign.py code and works independently.
        Using the iteralign.py code on the mmi file generated above can result in targets being identified.
        I believe the problem is that the previous centrifuge subprocess is interfering with the following code.
        Working on a fix.
        """
...
def main():
    ...
    """
    d["conditions"]["reference"] = args.path + args.prefix + args.mindex
