...
LATEST_TESTED = 5.9
# Warning is the last tested version of MinKNOW for this version of readfish
# Users running a higher version of MinKNOW will receive the warning shown if they are running this version of readfish.
latest_tested_version_warning = (
    LATEST_TESTED,
    f"Readfish {__version__} has only been tested up to MinKNOW {LATEST_TESTED}. Please check for an update to readfish!",
)
...
def check_basecaller_compatibility(
    run_information: ProtocolRunInfo, op, version: str, extra_error: str | None = None
):
    symbol = {
        operator.lt: "<",
        operator.gt: ">",
